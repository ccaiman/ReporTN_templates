...
#path1 <- "E:/2023 - FALLS Event Tracking.xlsx"
#path1.2 <- "E:/2022 - FALLS Event Tracking.xlsm"
...
if (month[1] == "NA") {
  ...
  print(
    str_glue("# {year} yearly fall events")
    )
  ...
  print(
    str_glue("# {year} Q{quart$quart[1]} fall events")
    )
}
...
#log data prep
fall_data_report <- quarterly_report_months(fall_data)
